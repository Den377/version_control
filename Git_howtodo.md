...
5. На странице нашей копии репозитория на GitHub, появится возможность отправить наши изменения тому у кого мы скопировали репозиторий - кнопка "Compare & Pull Request".
